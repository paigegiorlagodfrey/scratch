...
#!	open HD19467B and read in the arrays for wavelength, flux, and uncertainty
	W,F,U=db.query.execute("select wavelength, flux, unc from spectra where id=15").fetchone()	
...
#!		loop through 21 iterations for the amount of wavelength ranges I have
	...
	object=np.array([W_obj,F_obj,U_obj])																#to make sure all spaces in between points are the same length
...
#!		plot template over template's original flux
		...
		plt.savefig('/Users/paigegiorla/Code/Python/BDNYC/TDwarfplotting/HD19467B_project/SanityCheckplots/binned_flux_with_original/'+'{}'.format(name)+ '.pdf')
		plt.clf()  	
...
#!		plot template over object
		...
		plt.savefig('/Users/paigegiorla/Code/Python/BDNYC/TDwarfplotting/HD19467B_project/SanityCheckplots/template_over_object/'+'{}'.format(name)+ '_HD19467.pdf')
		plt.clf()
#-----------------------------------------------------------------------------------------
		try:
...
#!	plotting the best fits, or minimum chi squared values over the object
	...
	plt.savefig('/Users/paigegiorla/Code/Python/BDNYC/TDwarfplotting/HD19467B_project/SanityCheckplots/bestfits_w_object.pdf')
 	plt.clf()	
...
#!	plot spectral type vs chi square
	...
	plt.savefig('/Users/paigegiorla/Code/Python/BDNYC/TDwarfplotting/HD19467B_project/SanityCheckplots/chisquare_distribution.pdf')
	plt.clf()	
